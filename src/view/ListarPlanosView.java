...
public class ListarPlanosView implements Observer {
    ...
    public void loopTela() {
        while (!controller.isLogoutSolicitado()) {
            exibirTelaListagem();
        }
    }
                    ...
                    if (planos.isEmpty()) {
                        ...
                        if (indice >= 0 && indice < planos.size()) {
                            ...
                            if (plano.getStatus() == StatusPlano.PENDENTE || plano.getStatus() == StatusPlano.REPROVADO) {
                                ...
                                System.out.println("Apenas planos pendentes ou reprovados podem ser editados.");
                            }
                        } else {
                            System.out.println("Número inválido.");
                        }
                    ...
                    if (planos.isEmpty()) {
                        ...
                        if (indice >= 0 && indice < planos.size()) {
                            ...
                            if (plano.getStatus() == StatusPlano.PENDENTE || plano.getStatus() == StatusPlano.REPROVADO) {
                                ...
                                System.out.println("Plano submetido: " + controller.getDisciplinaPorPlano(plano.getIdPlanoDeEnsino()).getNome());
                            } else {
                                System.out.println("Apenas planos pendentes ou reprovados podem ser submetidos.");
                            }
                        } else {
                            System.out.println("Número inválido.");
                        }
                    ...
                    if (planos.isEmpty()) {
                        ...
                        if (indice >= 0 && indice < planos.size()) {
                            ...
                            if (plano.getStatus() == StatusPlano.EM_REVISAO) {
                                ...
                                System.out.println("Plano aprovado: " + controller.getDisciplinaPorPlano(plano.getIdPlanoDeEnsino()).getNome());
                            } else {
                    ...
                    if (planos.isEmpty()) {
                        ...
                        if (indice >= 0 && indice < planos.size()) {
                            ...
                            if (plano.getStatus() == StatusPlano.EM_REVISAO) {
                                ...
                                System.out.println("Plano reprovado: " + controller.getDisciplinaPorPlano(plano.getIdPlanoDeEnsino()).getNome() + " (Justificativa: " + justificativa + ")");
                            } else {
